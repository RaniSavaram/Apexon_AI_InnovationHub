...
class GovernanceValidator:
    ...
    # Sourced from each table's optional "recent_statements" list - not
    # currently populated by any extractor (Databricks' extract() only reads
    # information_schema.tables/columns, no query history yet), so this is a
    # dormant check until an extractor starts capturing that data.
