Logs = {"Token Info":[],"Scan Info":[],"Progress Percentage":int(),"Harness Layer1":[],"Harness Layer2":[]}
def reset_Logs():
    ...
    Logs.clear()
    Logs.update({"Token Info":[],"Scan Info":[],"Progress Percentage":int(),"Harness Layer1":[],"Harness Layer2":[]})